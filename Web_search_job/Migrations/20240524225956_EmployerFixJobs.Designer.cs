...
namespace Web_search_job.Migrations
{
    ...
    [Migration("20240524225956_EmployerFixJobs")]
    partial class EmployerFixJobs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_search_job.DatabaseClasses.Employer", b =>
                {
                    ...
                    b.HasOne("Web_search_job.DatabaseClasses.UserInfo", "UserInfo")
                        .WithOne("Employer")
                        .HasForeignKey("Web_search_job.DatabaseClasses.Employer", "user_id");
            ...
            modelBuilder.Entity("Web_search_job.DatabaseClasses.Job", b =>
                {
                    b.HasOne("Web_search_job.DatabaseClasses.Employer", null)
                        .WithMany("Jobs")
