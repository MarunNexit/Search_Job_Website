...
namespace Web_search_job.Migrations
{
    ...
    [Migration("20240601123214_ResumeRecomendationChanges")]
    partial class ResumeRecomendationChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_search_job.DatabaseClasses.JobFolder.JobRecommendationList", b =>
                {
                    b.HasOne("Web_search_job.DatabaseClasses.Job", null)
                        .WithMany("JobRecommendationList")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_search_job.DatabaseClasses.UserInfo", null)
                        .WithMany("JobRecommendationList")
